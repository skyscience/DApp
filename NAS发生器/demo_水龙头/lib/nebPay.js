...
require = function () {
  ...
  5: [function (require, module, exports) {
    ...
    var QRCode = require("./qrcode"); //var Config = require("./config");
      ...
      function constructorFactory(config) {
        ...
        function BigNumber(n, b) {
          ...
          if (b == null || !isValidInt(b, 2, 64, id, 'base')) {
            ...
            if (b == 10) {
              x = new BigNumber(_instanceof(n, BigNumber) ? n : str);
  ...
  37: [function (require, module, exports) {
    ...
    function Buffer(arg, offset, length) {
      if (!Buffer.TYPED_ARRAY_SUPPORT && !_instanceof(this, Buffer)) {
    ...
    function fromObject(that, obj) {
      ...
      if (obj) {
        if (typeof ArrayBuffer !== 'undefined' && _instanceof(obj.buffer, ArrayBuffer) || 'length' in obj) {
    ...
    function byteLength(string) {
      ...
      if (typeof ArrayBuffer !== 'undefined' && typeof ArrayBuffer.isView === 'function' && (ArrayBuffer.isView(string) || _instanceof(string, ArrayBuffer))) {
    ...
    function from(that, value, offset, length) {
      ...
      if (typeof ArrayBuffer !== 'undefined' && _instanceof(value, ArrayBuffer)) {
  ...
  38: [function (require, module, exports) {
    (function (global) {
      ...
      module.exports = (typeof self === "undefined" ? "undefined" : _typeof(self)) === 'object' && self.self === self && self || _typeof(global) === 'object' && global.global === global && global || this;
